...
- Capacity-audited creative LinkedStnNoiseMorph v3 brief: [architecture/offline-creative-linked-stn-noise-morph-brief.md](./architecture/offline-creative-linked-stn-noise-morph-brief.md)
...
Run `g10.031` Batch 31.47 only under the fresh capacity-audited v3 identity.
Implement once in `signal-candidate-31-47`, then run construction, structural,
and synthetic admission in order. Do not recover Batch 31.45 or change routing,
