...
- `g10` is the active generation. Its front door is
  ...
  `AuditedLayeredCloud` identity; Batch 31.72 freezes its complete authority.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` privately admitted fixed-ratio `DirectRenewalDream`; Batch 31.70 Cloud evidence is invalid and Batch 31.72 audited authority is next |
...
brief from canonical architecture and the Batch 31.71 gap ledger. Do not
recover Batch 31.70 source or output. Keep admitted renderers, overlaps,
routing, controls, cache, dynamic ratio, product exposure, Loophole, and
