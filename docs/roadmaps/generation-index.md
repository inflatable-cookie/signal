...
- `g10` is the active generation. Its front door is
  ...
  closed the identity after its second incomplete-evidence checkpoint. No
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline; `g10.031` publicly admits exact `4x`/`8x`/`16x` Dream; `g10.032` closed centred compressed-anchor Cyclic after its second incomplete-evidence checkpoint |
