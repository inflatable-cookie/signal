...
- `g10` is the active generation. Its front door is
  ...
  synthetic `Y08`; Batch 31.35 owns the impulse-support evidence audit.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has an impulse-support evidence audit ready |
...
Run `g10.031` Batch 31.35 only. Reconcile the `Y08` impulse-support boundary
without DSP. Keep transparent stretch, other creative owners, product
exposure, and candidate DSP on `main` closed.
