...
- `g10` is the active generation. Its front door is
  ...
  froze reproducible manifests; Batch 32.11 isolated conformance is ready. No
  Cyclic candidate is admitted.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline; `g10.031` publicly admits exact `4x`/`8x`/`16x` Dream; `g10.032` has reconciled reproducible Cyclic manifests with Batch 32.11 isolated conformance ready |
...
bind its new comparator set, implement the unchanged renderer and owners, and
complete two structural conformance rounds. Stop before acoustic execution.
