...
- `g10` is the active generation. Its front door is
  ...
  through reassessment. Batch 31.56 is ready for docs-only owner eligibility
  and selection.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has creative owner selection ready |
...
select at most one complete source-backed owner or pause. Keep transparent
stretch, routing, and product exposure unchanged. Do not recover candidate
source, implement DSP, merge, or push.
