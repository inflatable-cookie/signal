...
- `g10` is the active generation. Its front door is
  ...
  target remains without a ready renderer.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` is paused without a creative renderer owner |
...
No `g10.031` implementation batch is ready. Keep transparent stretch, product
exposure, and candidate implementation closed until the operator explicitly
authorizes materially different creative-owner research.
