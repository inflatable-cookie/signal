...
- `g10` is the active generation. Its front door is
  ...
  before compile or checkpoint. Geometry-authority reconciliation is next.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` requires Linked STN geometry-authority reconciliation |
...
all geometry-derived STN median bounds before any fresh candidate authority.
Keep transparent stretch, routing, and product exposure unchanged. Do not
implement DSP, recover deleted candidate code, or merge a candidate.
