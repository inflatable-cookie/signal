...
- `g10` is the active generation. Its front door is
  ...
  The candidate was deleted; bounded-state reassessment is next.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` is reassessing bounded Linked STN execution after structural rejection |
...
reassessment. Keep transparent stretch, `main`, routing, and product exposure
unchanged. Do not implement another candidate.
