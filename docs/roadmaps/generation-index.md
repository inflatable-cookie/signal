...
- `g10` is the active generation. Its front door is
  ...
  renderer and evidence brief without DSP. One isolated implementation batch
  is now ready.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has one isolated Linked STN candidate ready |
...
Run `g10.031` Batch 31.43 only in the disposable worktree named by the frozen
`LinkedStnNoiseMorph` brief. Keep transparent stretch, `main`, routing, and
product exposure unchanged.
