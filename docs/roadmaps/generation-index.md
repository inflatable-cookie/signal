...
- `g10` is the active generation. Its front door is
  ...
  continuous Cyclic feasibility with a docs-only compatibility and domain
  audit.
...
Execute `g10.034` Batch 34.1 only.
