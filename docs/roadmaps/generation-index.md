...
- `g10` is the active generation. Its front door is
  ...
  unopened listening pack and isolated candidate were deleted. Batch 31.24 is
  ready for docs-only evidence-integrity reassessment.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has one docs-only evidence reassessment ready without renderer admission |
...
candidate brief is warranted. Keep transparent stretch, other creative owners,
