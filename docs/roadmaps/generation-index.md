...
- `g10` is the active generation. Its front door is
  ...
  synthetic or listening. Batch 31.54 is ready as docs-only executable-
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has linked-STN executable-authority reassessment ready |
...
`LinkedStnNoiseMorph`. Keep transparent stretch, routing, and product exposure
unchanged. Do not recover checkpoint `366ac24b`, implement DSP, merge, or push.
