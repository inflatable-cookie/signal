...
- `g10` is the active generation. Its front door is
  ...
  authoritative in construction and `S02`. Construction-bound v6 is ready.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has construction-bound linked-STN v6 ready |
...
synthetic admission in order. Keep transparent stretch, routing, and product
exposure unchanged. Do not repair Batch 31.51, merge, or push.
