...
- `g10` is the active generation. Its front door is
  ...
  authority. Batch 31.23 is ready for one isolated candidate.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has one creative candidate brief ready without renderer admission |
...
worktree. Keep transparent stretch, other creative owners, and candidate
surfaces on `main` closed.
