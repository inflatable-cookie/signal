...
- `g10` is the active generation. Its front door is
  ...
  publishes the exact executable matrix and closes the lane.
...
Open one docs-first continuous Cyclic feasibility roadmap.
