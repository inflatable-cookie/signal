...
- `g10` is the active generation. Its front door is
  ...
  explicit, and makes only the complete docs brief ready.
...
Execute `g10.035` Batch 35.2 only as documentation. Stop before candidate
