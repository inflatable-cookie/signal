...
- `g10` is the active generation. Its front door is
  ...
  fresh listening-led authority; Batch 31.34 is ready.
...
| `g10` | 2026-06-11 | Turn the 2026-06-11 deep audit into a remediation program: fix the real audio path, demolish simulated/narration mass (~70-80k LoC), consolidate hygiene, defer rebuilds to demand | Active; `g10.030` retained the frozen stretch baseline and `g10.031` has a listening-led renewal candidate ready |
...
Run `g10.031` Batch 31.34 only under the frozen listening-led source-relative
brief. Keep transparent stretch, other creative owners, product exposure, and
