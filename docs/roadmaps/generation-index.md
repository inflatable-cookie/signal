...
Execute `g10.035` Batch 35.5 only in the newly named disposable worktree.
Restore and hash-prove the exact candidate source, pass conformance twice,
freeze the new acoustic checkpoint, and restart the corrected gate at
identity/parity.
