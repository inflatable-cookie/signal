...
Batch 31.13 is next. No candidate DSP is admitted on `main`.
...
docs-only `g10.031` Batch 31.13; freeze one complete
`SimilarityAlignedCyclic` brief while keeping rejected candidate families, the
