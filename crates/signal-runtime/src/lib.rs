...
pub use interfaces::{
    ...
    RuntimeOfflineStretchArtifactPlanRegistration, RuntimeOfflineStretchArtifactPlanSnapshot,
    RuntimeOfflineStretchArtifactPlanSnapshotSet, RuntimeOfflineStretchArtifactReadiness,
...
pub use signal_dsp_stretch::{
    ...
    StretchPromotionReceipt, StretchPromotionStatus, StretchRatioPoint,
