...
pub use interfaces::{
    ...
    LingeringCleanupTrigger, LoopRegion, ParameterBatch, ParameterEvent,
    PluginBackedNodeBinding, PluginBackedNodeBindingProjection, PluginFaultKind,
    PluginFaultRecord, PluginSandboxLifecycleRecord, PluginSandboxLifecycleStage,
    PluginSandboxSpec, PluginSandboxTransportRecord, PluginSandboxTransportStage,
    PluginScanRequest, ProjectionReceipt, RecoveryRecord, RecoveryRestartIntent, RestartRequest,
