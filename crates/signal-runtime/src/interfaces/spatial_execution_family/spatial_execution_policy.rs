...
pub(super) struct RuntimeSpatialRoomPolicyInput {
...
pub fn runtime_immersive_room_policy_summary_for_spatial(
...
pub fn runtime_deployment_monitoring_summary_for_spatial(
...
pub fn runtime_renderer_immersive_export_summary_for_spatial(
