...
pub(crate) fn sample_discovered_type_record() -> RuntimePluginDiscoveredTypeRecord {
...
pub(crate) fn sample_backend_breadth_record() -> RuntimePluginDiscoveredTypeRecord {
    RuntimePluginDiscoveredTypeRecord {
...
pub(crate) fn sample_au_breadth_record() -> RuntimePluginDiscoveredTypeRecord {
    RuntimePluginDiscoveredTypeRecord {
