...
mod tests {
    ...
    use bar_transition_basic::build_bar_transition_basic;
    use bar_transition_reentry::build_bar_transition_reentry;
    use bar_transition_reentry_extended::build_bar_transition_reentry_extended;
    ...
    fn build_bar_transition_preset(
        ...
        match variant {
            _ => unreachable!("unhandled bar transition variant"),
        }
    }
