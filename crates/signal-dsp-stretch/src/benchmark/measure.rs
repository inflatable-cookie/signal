...
use super::synthetic::{
    deinterleave_channel, interleave_channels, stretch_stereo_synthetic,
    stretch_stereo_synthetic_linked, synthetic_extreme_ratio, synthetic_loop_seam,
    synthetic_sustained_material,
};
use super::types::{
    StretchCoherenceComparison, StretchDynamicSegmentSeamMeasurement,
    StretchLoopBoundaryMeasurement, StretchMetric, StretchMetricValue,
    StretchPitchShiftMeasurement, StretchStereoImageMeasurement,
};
...
pub(super) fn loop_boundary_nan(ratio: f64, channels: u16) -> StretchLoopBoundaryMeasurement {
    StretchLoopBoundaryMeasurement {
        ratio,
        channels,
...
pub(super) fn stereo_image_nan(ratio: f64) -> StretchStereoImageMeasurement {
    StretchStereoImageMeasurement {
        ratio,
...
pub(crate) fn smooth_loop_boundary_interleaved(
