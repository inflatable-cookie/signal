use crate::benchmark::{
    compare_synthetic_stretch_backends, StretchBenchmarkPath, StretchCorpusAssetRequirement,
    StretchCorpusCase, StretchCorpusManifest, StretchCorpusManifestEntry,
    StretchCorpusMissingAssetBehavior, StretchSyntheticBenchmarkComparison,
    StretchSyntheticBenchmarkComparisonReport, STRETCH_CORPUS_MANIFEST,
};
...
pub fn format_stretch_corpus_comparison_report(report: &StretchCorpusComparisonReport) -> String {
    ...
    lines.push(format!(
        "summary comparisons={} missing_assets={} optional_benchmark_skips={} listening_note_slots={} improved={} regressed={} unchanged={} inconclusive={}",
        report.synthetic_report.comparisons.len(),
