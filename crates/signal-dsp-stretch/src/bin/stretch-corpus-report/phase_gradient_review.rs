...
impl PhaseGradientReviewEvidence<'_> {
    pub fn format_report_line(&self) -> String {
        ...
        format!(
            ...
            evidence.analysis_interval_floor_count,
            evidence.analysis_interval_ceiling_count,
            evidence.max_analysis_mapping_error_frames,
            evidence.final_analysis_mapping_error_frames,
            evidence.analysis_positions_monotonic,
