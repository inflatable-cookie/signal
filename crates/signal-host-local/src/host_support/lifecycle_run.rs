...
use signal_plugin::{
    CompletionState, PluginRenderContext, SandboxWatchdogState, WatchdogTriggerReason,
};
...
pub(crate) struct LifecycleRunSummary {
    ...
    pub(crate) last_plugin_render_context: Option<PluginRenderContext>,
    pub(crate) last_plugin_automation_value: Option<f32>,
    pub(crate) plugin_render_bypass_count: u32,
    pub(crate) last_plugin_render_bypassed: bool,
    pub(crate) last_plugin_render_latency_samples: u32,
    pub(crate) last_plugin_render_tail_samples: u32,
